...
class Worlflows:
    def create_resume_workflow():
        ...
        workflow.add_node("generate_summary", Nodes.generate_summary_node)
        ...
        workflow.add_edge("generate_project_summaries", "generate_summary")
        workflow.add_edge("generate_summary", "save_resume")
