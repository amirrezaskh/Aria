...
def format_resume(highlights, experiences, skills, projects):
    return f"""
...
def save_resume(company, job, highlights, experiences, skills, projects):
    resume_txt = format_resume(highlights, experiences, skills, projects)
    dir_path = f"./output/resumes/{company}"
    os.makedirs(dir_path, exist_ok=True)
    file_path = os.path.join(dir_path, f"{job}.tex")
